...
<nav class="top-bar animate-dropdown">
    <div class="container">
        <div class="col-xs-12 col-sm-6 no-margin">
            <ul>
                <li><a href="http://localhost/~ibrahim/themeforest/HTML/mediacenter/upload/PHP/index.html">Home</a></li>
                <li class="dropdown">
...
<header class="no-padding-bottom header-alt">
    <div class="container no-padding">
        ...
        <div class="col-xs-12 col-md-3 logo-holder">
			<!-- ============================================================= LOGO ============================================================= -->
<div class="logo">
	<a href="http://localhost/~ibrahim/themeforest/HTML/mediacenter/upload/HEADER1/index.html">
		<!--<img alt="logo" src="resources/assets/images/logo.svg" width="233" height="54"/>-->
		<!--<object id="sp" type="image/svg+xml" data="resources/assets/images/logo.svg" width="233" height="54"></object>-->
