			...
			<div class="row">
				<div class="col-md-8 center-block">
					<div class="info-404 text-center">
						<h2 class="primary-color inner-bottom-xs">${error}</h2>
						<div class="text-center">
							<a href="${pageContext.request.contextPath}/index.html" class="btn-lg huge"><i class="fa fa-home"></i> <spring:message code="main.go_to_home_page"/></a>
						</div>
					</div>
				</div>
			</div>
